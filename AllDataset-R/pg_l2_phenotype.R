...
# Heatmap
heatmap_plot_path <- file.path(fig_dir, "pg_l2_heatmap_500.png")
...
#  UMAP embedding
umap_plot_path <- file.path(fig_dir, "pg_l2_umap_500.png")
...
# dot_plot_path <- file.path(fig_dir, "pg_l2_dotplot_500.png")
