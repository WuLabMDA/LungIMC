...
# Heatmap
heatmap_plot_path <- file.path(fig_dir, "pg_l2_heatmap_1000.png")
...
#  UMAP embedding
umap_plot_path <- file.path(fig_dir, "pg_l2_umap_1000.png")
...
dot_plot_path <- file.path(fig_dir, "pg_l2_dotplot_1000.png")
