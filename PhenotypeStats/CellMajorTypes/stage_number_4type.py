...
def set_args():
    parser = argparse.ArgumentParser(description = "Assess the cell numbers of 4 major types")
...
if __name__ == "__main__":
    ...
    for cur_stage in stage_lst:
        ...
        other_immune_lst.append(other_immune_num)
    ...
    plot_name = "major_4type_stage_num"
