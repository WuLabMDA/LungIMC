...
immune_lst <- c("CD4-T-Cell", "CD8-T-Cell", "T-Reg-Cell", "B-Cell")
...
immune_density_plot_path <- file.path(data_root_dir, "NatureFigures", "Fig01", "Stage-Adaptive-Density-New.pdf")
ggsave(filename = immune_density_plot_path, device='pdf', width=8, height=8, dpi=300)
while (!is.null(dev.list()))
    dev.off()


immune_density_pfile <- file(file.path(data_root_dir, "NatureFigures", "Fig01", "Stage-Adaptive-Density-pval.txt"), "w")
