...
immune_ratio_plot_path <- file.path(data_root_dir, "NatureFigures", "Fig01", "Stage-Adaptive-All-Ratio.pdf")
ggsave(filename = immune_ratio_plot_path, device='pdf', width=8, height=8, dpi=300)
while (!is.null(dev.list()))
    dev.off()


immune_ratio_pfile <- file(file.path(data_root_dir, "NatureFigures", "Fig01", "Stage-Adaptive-All-Ratio-pval.txt"), "w")
