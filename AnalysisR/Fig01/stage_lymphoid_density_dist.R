...
immune_lst <- c("CD4-T-Cell", "CD8-T-Cell", "T-Reg-Cell", "B-Cell", "NK-Cell")
...
immune_density_pfile <- file(file.path(data_root_dir, "NatureFigures", "Fig01", "Stage-Lymphoid-Density-pval.txt"), "w")
