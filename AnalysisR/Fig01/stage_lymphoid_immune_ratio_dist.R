...
immune_density_plot_path <- file.path(data_root_dir, "NatureFigures", "Fig01", "Stage-Lymphoid-Immune-Ratio.pdf")
ggsave(filename = immune_density_plot_path, device='pdf', width=8, height=8, dpi=300)
while (!is.null(dev.list()))
    dev.off()

immune_ratio_pfile <- file(file.path(data_root_dir, "NatureFigures", "Fig01", "Stage-Lymphoid-Immune-Ratio-pval.txt"), "w")
