...
subtype_interaction_dir <- file.path(data_root_dir, "NatureFigures", "Fig02", "AdjacentDistantInteraction", "23DistantNormal")
...
for (path_stage in interested_stages) {
    ...
    subtype_interaction_plot_path <- file.path(subtype_interaction_dir, paste0("Distant-", path_stage, ".pdf"))
