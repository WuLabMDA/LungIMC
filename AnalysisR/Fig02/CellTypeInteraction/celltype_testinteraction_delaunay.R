...
spe <- buildSpatialGraph(spe, img_id = "sample_id", type = "delaunay", threshold = 30)
...
interaction_out <- testInteractions(spe, group_by = "sample_id",
                                    ...
                                    patch_size = 3,
                                    iter = 200)
cell_type_spatial_path <- file.path(phenotype_dir, paste0("InteractionsTestIter200Delaunay", ".RData"))
