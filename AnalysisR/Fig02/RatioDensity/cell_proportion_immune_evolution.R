...
cell_ratio_lst <- c()
# list all cell types
interested_cell_lst <- c("CD4-T-Cell", "CD8-T-Cell", "T-Reg-Cell", "B-Cell", "Macrophage", 
...
stage_cell_ratio_path <- file.path(proportion_evolution_dir, "stage_immune_cell_ratios.csv")
