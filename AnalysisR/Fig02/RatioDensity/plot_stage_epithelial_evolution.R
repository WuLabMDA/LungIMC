...
stage_subcell_ratio_path <- file.path(subtype_proportion_dir, "stage_epithelial_cell_ratios.csv")
...
cell_type_orders <- c("CD73+ Epithelial", "Ki67+ Epithelial", "Ki67+ PDL1+ Epithelial", "Other Epithelial")
...
stage_all_cell_plot_path <- file.path(subtype_proportion_dir, "stage_epithelial_cell_ratios.pdf")
