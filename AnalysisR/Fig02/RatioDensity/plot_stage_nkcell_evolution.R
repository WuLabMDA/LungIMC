...
stage_subcell_ratio_path <- file.path(subtype_proportion_dir, "stage_NK_cell_ratios.csv")
...
cell_type_orders <- c("Ki67- NK Cells", "Ki67+ NK Cells")
...
stage_all_cell_plot_path <- file.path(subtype_proportion_dir, "stage_NK_cell_ratios.pdf")
