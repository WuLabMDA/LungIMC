...
cell_type_orders <- c("Cytotoxic CD8 T-Cells", "Exhausted CD8 T-Cells", "Ki67+ CD8 T-Cells", "Memory CD8 T-Cells", "Naive CD8 T-Cells")
...
stage_all_cell_plot_path <- file.path(subtype_proportion_dir, "stage_CD8T_cell_ratios.pdf")
