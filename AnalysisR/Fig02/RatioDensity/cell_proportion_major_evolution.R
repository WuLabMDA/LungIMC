...
cell_ratio_lst <- c()
# list all cell types
interested_cell_lst <- c("Epithelial-Cell", "B-Cell", "Neutrophil", "NK-Cell", "Dendritic-Cell", "Endothelial-Cell",
...
stage_cell_ratio_path <- file.path(proportion_evolution_dir, "stage_major_cell_ratios.csv")
