...
stage_subcell_ratio_path <- file.path(subtype_proportion_dir, "stage_Treg_cell_ratios.csv")
...
cell_type_orders <- c("Ki67- Treg-Cells", "Ki67+ Treg-Cells")
...
stage_all_cell_plot_path <- file.path(subtype_proportion_dir, "stage_Treg_cell_ratios.pdf")
