...
subtype_proportion_dir <- file.path(data_root_dir, "NatureFigures", "Fig02", "ProportionDensity", "NKCellProportion")
if (!file.exists(subtype_proportion_dir))
    dir.create(subtype_proportion_dir, recursive = TRUE)

# list all cell subtypes
interested_cell_lst <- c("Ki67- NK Cells", "Ki67+ NK Cells")
