...
subtype_proportion_dir <- file.path(data_root_dir, "NatureFigures", "Fig02", "ProportionDensity", "TregCellProportion")
if (!file.exists(subtype_proportion_dir))
    dir.create(subtype_proportion_dir, recursive = TRUE)

# list all cell subtypes
interested_cell_lst <- c("Ki67- Treg-Cells", "Ki67+ Treg-Cells")
