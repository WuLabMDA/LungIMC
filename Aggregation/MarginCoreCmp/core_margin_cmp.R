...
# fea_name <- "CD8.T.Cell.Proportion"
# fea_name <- "CD8.T.Cell.Density"
# fea_name <- "Macrophage.Proportion"
# fea_name <- "Macrophage.Density"
# fea_name <- "B.Cell.Proportion"
fea_name <- "Macrophage.Epithelial.Cell"
...
# plot
ggpaired(cmp_df, cond1 = "Margin", cond2 = "Core", fill = "condition", 
