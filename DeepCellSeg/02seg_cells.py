...
def set_args():
    ...
    parser.add_argument("--roi_dir",                type=str,       default="SegStainROIs")
    parser.add_argument("--result_dir",             type=str,       default="SegCellResults")
    parser.add_argument("--nuc_stain",              type=str,       default="Ir191")
...
if __name__ == "__main__":
    args = set_args()
    seg_root_dir = os.path.join(args.data_root, args.data_type, args.cellseg_dir)
