...
def set_args():
    ...
    parser.add_argument("--stain_dir",              type=str,       default="RawROIs")
...
if __name__ == "__main__":
    ...
    raw_spillover_dir = os.path.join(root_dir, args.denoise_dir, args.spillover_dir, "Raw")
    if os.path.exists(raw_spillover_dir):
        shutil.rmtree(raw_spillover_dir)
    os.makedirs(raw_spillover_dir)

    stain_root = os.path.join(root_dir, args.denoise_dir, args.stain_dir)
