...
% roi_root_dir = 'E:\LungIMCData\TonsilIMC\TonsilROIProcessing\Denoise';
...
stain_pixel_num = [50, 50, 37, 20, 20, 20, 37, 37, 50, 20, ...
    50, 37, 50, 50, 50, 50, 50, 37, 50, 35, 37, 25, ...
    50, 25, 37, 25, 50, 25, 35, 50, 35, 30, 25, 25, 35];
stain_agg_map = containers.Map(stain_str_list, stain_pixel_num);
quantile_val_num = [0.95, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.50, 0.90, 0.30, ...
    0.85, 0.50, 0.05, 0.05, 0.30, 0.90, 0.90, 0.05, 0.90, 0.05, 0.05, 0.05, ...
    0.80, 0.05, 0.05, 0.05, 0.05, 0.05, 0.10, 0.05, 0.05, 0.05, 0.05, 0.05, 0.70];
