...
if __name__ == "__main__":
    ...
    # cell_phenotype_path = os.path.join(phenotype_dir, "CD8Tcells.xlsx")
    # cell_phenotype_df = pd.read_excel(cell_phenotype_path, header=0, index_col=None, sheet_name="Sheet1")
    cell_phenotype_path = os.path.join(phenotype_dir, "CD8Tcells.csv")
