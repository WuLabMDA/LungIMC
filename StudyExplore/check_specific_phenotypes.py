...
if __name__ == "__main__":
    ...
    cell_phenotype_dir = os.path.join(phenotype_dir, "CD8-T")
    ...
    for ind, roi_name in enumerate(seg_roi_lst):
        if roi_name not in roi_id_dict.keys():
            continue
        print("Superimpose on ROI {} {}/{} ".format(roi_name, ind+1, len(seg_roi_lst)))
        img_list = []
        ...
        cell_list = roi_id_dict[roi_name]
